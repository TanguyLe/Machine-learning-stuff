...
from notMNIST.constants import image_size, pixel_depth, letters
from notMNIST.paths import training_base_path, test_base_path, notMNIST_pickle_file
...
training_folders = [os.path.join(training_base_path, l) for l in letters]
test_folders = [os.path.join(test_base_path, l) for l in letters]
...
try:
    f = open(notMNIST_pickle_file, 'wb')
    save = {
    ...
    print('Unable to save data to', notMNIST_pickle_file, ':', e)
    raise

statinfo = os.stat(notMNIST_pickle_file)
